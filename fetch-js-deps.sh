...
curl -LO http://getbootstrap.com/2.3.2/assets/bootstrap.zip
curl -LO http://codemirror.net/codemirror-3.15.zip
curl -LO https://pagedown.googlecode.com/hg-history/f2a5240e53a726e3c39b92fab9dd25fd9b7614c4/Markdown.Converter.js
curl -LO http://code.jquery.com/jquery-1.10.1.min.js
